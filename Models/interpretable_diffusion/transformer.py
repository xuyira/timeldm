...
class Decoder(nn.Module):
    ...
    def forward(self, x, t, enc, padding_masks=None, label_emb=None, return_att=False):
        ...
        for block_idx in range(len(self.blocks)):
            x, residual_mean, residual_trend, residual_season = self.blocks[block_idx](x, enc, t, mask=padding_masks, label_emb=label_emb)
...
class Transformer(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        if self.num_classes is not None:
            self.label = nn.Embedding(num_classes, n_embd)
        ...
        self.combine_s = nn.Conv1d(n_embd, n_feat, kernel_size=1, stride=1, padding=0, padding_mode='circular', bias=False)
    ...
    def forward(self, input, t, padding_masks=None, y=None):
