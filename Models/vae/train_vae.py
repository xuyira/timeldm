...
if os.path.exists('/project'):
    ...
    base_path = r'F:\00_python-code\ST\Synthetic-Sleep-EEG-Signal-Generation-using-Latent-Diffusion-Models-main\data'
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=r"F:\00_python-code\ST\EEG_LDM\config\config_aekl_eeg_2_2_4.yaml",
    ...
    parser.add_argument(
        ...
        default=r"F:\00_python-code\ST\EEG_LDM\data\ids\ids_sleep_edfx_cassette_double_train.csv",
    )
    ...
    parser.add_argument(
        ...
        default=r"F:\00_python-code\ST\EEG_LDM\data\ids\ids_sleep_edfx_cassette_double_valid.csv",
    )
    parser.add_argument(
        "--path_cached_data",
        type=str,
        #default="/home/bru/PycharmProjects/DDPM-EEG/data/pre",
        default=r"F:\00_python-code\ST\EEG_LDM\data\pre",
    )
    ...
    parser.add_argument(
        ...
        default=r"F:\00_python-code\ST\EEG_LDM\data\pre-processed",
    )
...
def main(args):
    ...
    print('autoencoder_args', autoencoder_args)
    
    ''' autoencoder_args {
        'spatial_dims': 1, 'in_channels': 1, 'out_channels': 1, 'num_res_blocks': 2, 'norm_num_groups': 1, 'attention_levels': [False, False, False], 'with_encoder_nonlocal_attn': False, 'with_decoder_nonlocal_attn': False, 'num_channels': None, 'latent_channels': None}
'''
