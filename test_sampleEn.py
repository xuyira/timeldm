...
parser.add_argument('--feat_dim', type=int, default=28,help='Number of Variables in Time Series.')                  
parser.add_argument('--D_TOKEN', type=float, default=112,help='D_TOKEN')
...
parser.add_argument('--LDM_dim', type=int, default=6144,help='LDM_dim')
parser.add_argument('--embedding_save_path', type=str, default='./ckpt_vae/energy_112_1_16_2/train_z.npy', help='embedding_save_path')
parser.add_argument('--MLPDiffusion', type=str, default='./ckpt_ldm/ldm_energy_112_1_16_2/model_5000.pt')
parser.add_argument('--decoder', type=str, default='./ckpt_vae/energy_112_1_16_2/decoder.pt')
parser.add_argument('--save_npy', type=str, default='./Data/ldm_fake_energy_112.npy')             
