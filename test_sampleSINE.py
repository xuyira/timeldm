...
parser.add_argument('--feat_dim', type=int, default=5,help='Number of Variables in Time Series.')                  
parser.add_argument('--D_TOKEN', type=float, default=10,help='D_TOKEN')
...
parser.add_argument('--LDM_dim', type=int, default=2048,help='LDM_dim')
parser.add_argument('--embedding_save_path', type=str, default='./ckpt_vae/sine_10_1_16_2/train_z.npy', help='embedding_save_path')
parser.add_argument('--MLPDiffusion', type=str, default='./ckpt_ldm/ldm_sine_10_1_16_2/model_10000.pt')
parser.add_argument('--decoder', type=str, default='./ckpt_vae/sine_10_1_16_2/decoder.pt')
parser.add_argument('--save_npy', type=str, default='./Data/ldm_fake_SINE.npy')             
